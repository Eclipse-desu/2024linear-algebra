...
\newenvironment{theorem}[1][]
{
    ...
    \par\noindent\textbf{定理\arabic{section}.\arabic{theorem}}%
...
\newenvironment{definition}[1][]
{
    ...
    \par\noindent\textbf{定义\arabic{section}.\arabic{theorem}}%
    \ifthenelse{\equal{#1}{}}{}{ \textnormal{(#1)}}
}
{
    \end{tcolorbox}
...
\newenvironment{lemma}[1][]
{
    \refstepcounter{theorem}
    \begin{tcolorbox}[colback=thmcolor]
    \par\noindent\textbf{引理\arabic{section}.\arabic{theorem}}%
    \ifthenelse{\equal{#1}{}}{}{ \textnormal{(#1)}}\\
}
{
    \end{tcolorbox}
...
\newenvironment{corollary}[1][]
{
    \refstepcounter{theorem}
    \begin{tcolorbox}[colback=thmcolor]
    \par\noindent\textbf{推论\arabic{section}.\arabic{theorem}}%
    \ifthenelse{\equal{#1}{}}{}{ \textnormal{(#1)}}\\
}
{
    \end{tcolorbox}
